...
const Navbar = () => {
  ...
  const links = (
        ...
        <NavLink
          ...
          className={({ isActive, isPending }) =>
            isPending
              ? ""
              : isActive
              ? "bg-black text-white hover:bg-green-900 hover:text-white font-bold"
    ...
    <button onClick={handleToggleTheme} className="btn btn-ghost text-white">
        Toggle Theme
      </button>
    </div>
  );
  ...
  return (
    <div className="navbar bg-purple-800 shadow-xl lg:px-16 lg:py-5">
      <div className="navbar-start">
        ...
        <img
          className="h-[70px]"
          src="https://i.ibb.co/LQs8Nqw/image.png"
          alt=""
        />
      </div>
        ...
        {user ? (
          <div className="flex flex-col justify-center items-center md:flex-row">
            ...
            <img
              src={user.photoURL}
              alt=""
              className="w-[50px] h-[50px] rounded-full m-5"
            />
            <button
              onClick={handleSignOut}
              className="px-5 py-1 lg:py-2 font-bold rounded-full bg-red-900 text-white"
            >
              Log Out
            </button>
          </div>
          ...
          <div>
            <Link to={"/login"} className="flex ">
              <BsPersonCircle className="text-5xl text-white font-bold mx-3" />
              <button className="px-5 py-1 lg:py-2 font-bold rounded-full bg-red-900 text-white">
                Log In
              </button>
            </Link>
          </div>
